...
public class FgcJouneyService {
    ...
    public List<JourneyDTO> getAllJourneysDTO() {
        ...
        return journeyRepository.findAllRawDTO();
    ...
    public JourneyId getJourneyId(String origin, String destination) {
       ...
       Journey journey = journeyRepository.findById(new JourneyId(origin,destination)).orElseThrow(() -> new JourneyDoesNotExistsException(origin, destination));
       return new JourneyId(origin, destination);
